...
How to use GFX Canvas: https://github.com/moononournation/Arduino_GFX/wiki/Canvas-Class
*/
...
//#define PIN_BLK 34  //specify an unused GPIO pin, or comment out this definition, if the display backlight is not used.
#define PIN_CS  22
#define PIN_DC  16
#define PIN_RES 4
#define PIN_SDA 23
