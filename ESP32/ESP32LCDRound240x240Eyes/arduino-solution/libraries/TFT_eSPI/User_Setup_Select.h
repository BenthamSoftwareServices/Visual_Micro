...
// The following disables false error messages about TOUCH_CS pin not defined, TFT_eSPI touch functions will not be available!
// Un-comment if warning messages are required.
